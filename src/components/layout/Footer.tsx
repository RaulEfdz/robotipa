      ...
      <div className="relative z-10">
        <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
          <div className="inline-flex items-center">
            {/* Logo */}
            <img src="/logo.png" alt="Logo Robotipa" className="w-24 h-auto" />
            {/* End Logo */}
            <div className="border-s border-neutral-700 ps-5 ms-5">
              <p className="text-sm text-neutral-400 font-sans">
                © {new Date().getFullYear()} Robotipa. Todos los derechos
                reservados.
              </p>
              <div className="flex gap-4 mt-2">
                {/* Aquí puedes poner tus enlaces manualmente */}
                <a
                  href="#"
                  className="text-neutral-400 hover:text-primary transition-colors text-xs font-sans"
                >
                  Twitter
                </a>
                <a
              ...
              <p className="text-xs mt-2 text-success font-sans">
